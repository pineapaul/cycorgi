...
const getColumns = (): Column[] => [
  { key: 'riskId', label: 'Risk ID', sortable: true, width: '160px' },
  { key: 'actions', label: 'Submit for Review', sortable: false, width: '200px' },
  { key: 'functionalUnit', label: 'Functional Unit', sortable: true, width: '200px' },
  { key: 'currentPhase', label: 'Current Phase', sortable: true, width: '160px' },
  { key: 'jiraTicket', label: 'JIRA Ticket', sortable: true, width: '140px' },
  { key: 'dateRiskRaised', label: 'Date Risk Raised', sortable: true, width: '180px' },
  { key: 'raisedBy', label: 'Raised By', sortable: true, width: '300px' },
  { key: 'riskOwner', label: 'Risk Owner', sortable: true, width: '300px' },
  { key: 'affectedSites', label: 'Affected Sites', sortable: true, width: '160px' },
  { key: 'threat', label: 'Threat', sortable: true, width: '300px' },
  { key: 'vulnerability', label: 'Vulnerability', sortable: true, width: '300px' },
  { key: 'riskStatement', label: 'Risk Statement', sortable: true, width: '500px' },
  { key: 'currentRiskRating', label: 'Current Risk Rating', sortable: true, width: '180px' },
  { key: 'dateResidualRiskAccepted', label: 'Date Residual Risk Accepted', sortable: true, width: '220px' },
  { key: 'residualRiskRating', label: 'Residual Risk Rating', sortable: true, width: '200px' },
  { key: 'workshopId', label: 'Workshop ID', sortable: true, width: '160px' }
]
